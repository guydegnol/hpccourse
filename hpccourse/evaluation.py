...
def get_cred(k="pi.pyc", d=None, p=None):
    ...
    with open(d + k, "w") as f:
        f.write(
            ...
            .replace("egzezqh234ehzqh22", p)
        )
    return d + k


def set_up_student(student_name, d="hpccourse/hpccourse/", p=None):
...
"""
    ...
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = get_cred(d=d, p=p)
    return student_name
